    ...
    <footer className="bg-very-dark-blue py-16">
      <div className="wrapper">
        <div className="lg:flex items-start">
          <div className="md:max-w-lg md:mx-auto flex items-stretch">
            ...
            <button className="get-start-btn ml-2 sm:!px-20">Go</button>
          </div>
          <div className="mt-14 md:mt-0 flex justify-center gap-20">
          ...
          <div className="mt-14 lg:mt-0 lg:flex flex-col">
            <ul className="social-links lg:order-2 flex items-center justify-center gap-12">
              <li>
                <button>
            ...
            <div className="mt-10 md:mt-0 mx-auto lg:order-1">
              <svg
