    ...
    <footer className="bg-very-dark-blue py-16">
      <div className="wrapper">
        <div className="lg:flex items-start justify-between">
          ...
          <div className="mt-14 lg:mt-0 flex justify-center gap-20 lg:gap-10">
          ...
          <div className="mt-14 lg:mt-0 lg:flex flex-col justify-between">
            <ul className="social-links lg:order-2 lg:mt-auto flex items-center justify-center gap-12">
              <li>
                <button>
