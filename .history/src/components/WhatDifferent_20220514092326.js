    ...
    <section className="mt-24">
      <div className="wrapper">
        <div className="md:flex gap-10 lg:gap-20">
          <div className="text-center mb-16 md:text-left what-diff-start">
          ...
          <div>
            <div className="what-diff-sect what-diff-sect-1">
            ...
            <div className="mt-12 what-diff-sect what-diff-sect-1">
              <div className="what-diff-head ">
            ...
            <div className="mt-12 what-diff-sect what-diff-sect-2">
              <div className="what-diff-head ">
