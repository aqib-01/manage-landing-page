    ...
    <footer className="bg-very-dark-blue py-16">
      <div className="wrapper">
        <div className="lg:flex items-stretch justify-between">
          <div className="lg:order-3 lg:flex flex-col">
            ...
            <p className="mt-auto hidden text-dark-grayish-blue text-center lg:block">
              Copyright 2022. All Rights Reserved.
            </p>
          </div>

          <div className="mt-14 lg:mt-0 lg:order-2 flex justify-center gap-20 lg:gap-16">
          ...
          <div className="mt-14 lg:mt-0 lg:flex flex-col lg:order-1">
            <ul
              className="social-links mt-auto lg:order-2
